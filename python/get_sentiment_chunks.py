...
NEGWORDS = "../data/sentiment_lists/negative-words.txt"
POSWORDS = "../data/sentiment_lists/positive-words.txt"
...
def get_sentiment_counts(chunks, poswords=poswords, negwords=negwords):
    ...
    for i, chunk in enumerate(chunks):
        ...
        counts.append({
                "index": i,
                "pos": sum(Counter(overlap_pos).values()),
                "poswords": list(overlap_pos),
                "neg": sum(Counter(overlap_neg).values()),
...
def main():
    ...
    print "Writing out sentiment.json!"
